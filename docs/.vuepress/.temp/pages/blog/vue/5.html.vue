<template><!--
 * @Author: your name
 * @Date: 2021-08-27 16:21:25
 * @LastEditTime: 2021-08-27 16:21:25
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /summary/docs/blog/vue/5.md
-->
<h1 id="【typescript-专题】之类型断言" tabindex="-1"><a class="header-anchor" href="#【typescript-专题】之类型断言" aria-hidden="true">#</a> 【TypeScript 专题】之类型断言</h1>
<blockquote>
