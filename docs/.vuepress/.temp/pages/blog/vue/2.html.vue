...
-->
<h1 id="【typescript入门】之引用类型在typescript中的应用" tabindex="-1"><a class="header-anchor" href="#【typescript入门】之引用类型在typescript中的应用" aria-hidden="true">#</a> 【Typescript入门】之引用类型在TypeScript中的应用</h1>
<blockquote>
