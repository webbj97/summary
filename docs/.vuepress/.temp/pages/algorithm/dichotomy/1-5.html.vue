<template><h1 id="_5-搜索旋转排序数组-middle" tabindex="-1"><a class="header-anchor" href="#_5-搜索旋转排序数组-middle" aria-hidden="true">#</a> 5.搜索旋转排序数组（middle）</h1>
...
<li>判断中间值是在有序区间内还是在无序区间内(因为只有1个转折点)
<ul>
...
<p>本文是二分查找-模版 I 的最后一题，你会发现这道题的难度确实提升了，但仔细分析，借助自己的写写画画，仍然可以找到模版I的影子，加油！</p>
